...
-- The data result proved that the new lander had a higher click rate than the homepage.
-- Pages of the products, cart, and shipping performed well with high click rates.
-- Pages of mrfuzzy and billing still need improving.